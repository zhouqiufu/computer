...
<script type="text/javascript">
	function getValue() {
		...
		$.post('Announce_smartupload.jsp', {
			announceTitle : $("#announceTitle").val(),
			announceAuthor : $("#announceAuthor").val(),
	...
	<div id="hd">
		<div class="wp">
			...
			<div id="pt" class="bm cl">
				<span>您当前所在的位置是：<font color="red">协会通知发布页面</font></span>
	...
	font-size: 14px !important;
			...
			<div class="bm vw">
				...
				<div class="h hm">
					<h1 class="ph">
						...
						标题 <br> <input type="text" size="120" maxlength="200"
								name="announceTitle" id="announceTitle">
					</h1>
					<p class="xg1">
						供稿: <input type="text" id="announceAuthor" name="announceAuthor" value="计算机协会">
					</p>
				...
				<div style="text-align: center;">
					<input id="btn" type="button" value="点击发布通知"
