	...
	<div id="hd">
		<div class="wp">
			...
			<div id="pt" class="bm cl">
				<span>您当前所在的位置是：<font color="red">删除页面：通知列表</font></span>
...
#portal_block_217 .dxb_bc a {
	font-size: 14px !important;
			...
			function send_data(num){
				...
				$.post('DeleteAnnounce.jsp',{news_title:data_news},function(data){
					if($.trim(data)!=false){
				...
				<div class="s">
					<div style="text-align: center;">
						<table border="solid " border-color="#03C">
							<tr>
								<td><font size="+1" color="red">&nbsp;&nbsp;通知标题&nbsp;&nbsp;</font></td>
							...
							ApplicationContext appContext = new ClassPathXmlApplicationContext(
								...
								List<AnnounceDomain> list_allTitle = announceService.getAllTitle();
								Iterator<AnnounceDomain> iterator_allTitle = list_allTitle.iterator();
								int all_num = announceService.getTotalResult();
								while(iterator_allTitle.hasNext()){
									AnnounceDomain announceDomain_allTitle = iterator_allTitle.next();
							%>

							<tr>
								<td id="data_td_<%=all_num%>">&nbsp;&nbsp;<%=announceDomain_allTitle.getAnnounceTitle() %>&nbsp;&nbsp;
								</td>
