...
<body id="nv_portal" class="pg_index">
	...
	<div id="hd">
		<div class="wp">
			...
			<div id="nv">
				您当前所在的位置：<font color="#FF0000">&nbsp;&nbsp;&nbsp;&nbsp;技术文章浏览&nbsp;&nbsp;&nbsp;&nbsp;</font>
			</div>
...
#portal_block_249 {
	...
	<%
		...
		int maxRowCount = technologyAreaService.getTotalResult();// 一共有多少行
		...
		if(firstResult_arg==null||firstResult_arg==""){
			...
			List<TechnologyArea>  list = technologyAreaService.getPagingResult(Integer.parseInt(firstResult_arg), rowsPerPage);
			
			Iterator iterator = list.iterator();
			TechnologyArea technologyArea = null;
			while(iterator.hasNext()){
		technologyArea = (TechnologyArea)iterator.next();
		%>
		
		
		<br/>
		<a target="_blank"  href="<%=basePath %><%= technologyArea.getHtml_path()%>"><%= technologyArea.getTechnologyTitle()%></a>	
	  ...
	  <li class="nv_page"><a class='btn' href="<%=basePath%>public/paging_620.jsp?firstResult_arg=0&pageNum_=<%=i %>">
		...
		%>
		<li class="nv_page"><a class='btn' href="<%= basePath%>public/paging_620.jsp?firstResult_arg=<%=temp_pageNum %>&pageNum_=<%=i %>"> 
