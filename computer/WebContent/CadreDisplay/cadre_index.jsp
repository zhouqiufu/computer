...
<body id="nv_portal" class="pg_index">
	...
	<div id="hd">
		<div class="wp">
			...
			<div id="nv">
				您当前所在的位置：<font color="#FF0000">&nbsp;&nbsp;&nbsp;&nbsp;计协历届干部介绍&nbsp;&nbsp;&nbsp;&nbsp;</font>
			</div>
...
#portal_block_249 {
	...
	border: 0px !important;
			...
			<div class="bm vw">
				...
				<div class="d" style="text-align: center;"><br/>
				<p>
<a href="<%=basePath%>CadreDisplay/cadre2013.html">计算机协会2013届干部简介</a>
</p>

<p>
<a href="<%=basePath%>CadreDisplay/cadre2012.html">计算机协会2012届干部简介</a>
</p>

<p>
<a href="<%=basePath%>CadreDisplay/cadre2011.html">计算机协会2011届干部简介</a>
</p>
