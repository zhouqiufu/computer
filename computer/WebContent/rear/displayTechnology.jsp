	...
	<div id="hd">
		<div class="wp">
			...
			<div id="pt" class="bm cl">
				<span>您当前所在的位置是：<font color="red">删除页面：技术文章列表</font></span>
...
#portal_block_217 .dxb_bc a {
	font-size: 14px !important;
			...
			function send_data(num){
				...
				$.post('DeleteTechnology.jsp',{news_title:data_news},function(data){
					if($.trim(data)!=false){
					...
					<div style="text-align: center;">
						<table border="solid " border-color="#03C">
							...
							ApplicationContext appContext = new ClassPathXmlApplicationContext(
								...
								List<TechnologyArea> list_allTitle = technologyAreaService.getAllTitle();
								Iterator<TechnologyArea> iterator_allTitle = list_allTitle.iterator();
								int all_num = technologyAreaService.getTotalResult();
								while(iterator_allTitle.hasNext()){
									TechnologyArea technologyArea_allTitle = iterator_allTitle.next();
							%>

							<tr>
								<td id="data_td_<%=all_num%>">&nbsp;&nbsp;<%=technologyArea_allTitle.getTechnologyTitle()%>&nbsp;&nbsp;
								</td>
